    ...
    <>
      {!simplified && (
        <div className="text-center mt-10">
          <input
            type="search"
            className="px-5 py-2 mb-5 border outline-none"
      ...
      <div className="grid  grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 px-16 mb-16 mt-6 ">
        {cryptos?.map((obj) => {
          return (
                  ...
                  <div className="flex flex-col gap-3 mx-auto">
                    <p className="text-gray-700 text-sm">
                      {obj.name} ({obj.symbol})
                                  ...
                                  {obj.change > 0 ? (
                    <div className="flex justify-center items-center  text-green-800 gap-1">
                      <CaretUpOutlined />
                      <p className="text-center ">{obj.change}%</p>
                    </div>
                                  ) : (
                    <div className="flex justify-center items-center  text-red-800 gap-1">
                      <CaretDownOutlined />
